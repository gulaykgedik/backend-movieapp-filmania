...
const Hero = ({ setSearchValue }) => {
  ...
  return (
    <div className="relative px-6 py-20 md:py-20 overflow-hidden">
      {/* Arkaplan */}
      ...
      <div className="container mx-auto relative z-10 animate-fade-in">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 bg-linear-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent">
          Hoşgeldiniz
        </h1>
